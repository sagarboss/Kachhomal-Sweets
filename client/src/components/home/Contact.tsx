        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-12">
              We'd love to welcome you to our shop. Whether you're looking for
              your daily namkeen or planning a major celebration, our doors are
              open.
            </p>
            ...
            <div className="absolute inset-0 rounded-2xl overflow-hidden shadow-2xl border-4 border-white bg-muted">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  We are also available on major food delivery platforms.
                </p>
                <div className="flex gap-4">
                  <a
                    href="https://www.zomato.com/mumbai/kachhomal-sweets-1-ulhasnagar/order"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-red-500 text-white font-bold py-2 rounded-sm hover:bg-red-600 transition-colors text-center block"
                  >
                    Zomato
                  </a>
                  <a
                    href="https://www.swiggy.com/city/mumbai/kachhomal-sweets-and-namkeen-ulhasnagar-rest1127727"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-orange-500 text-white font-bold py-2 rounded-sm hover:bg-orange-600 transition-colors text-center block"
                  >
                    Swiggy
                  </a>
                </div>
